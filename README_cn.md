...
我们提供了 [kitex-benchmark](https://github.com/minogump/kitex-benchmark) 项目用来长期追踪和比较 Kitex 与其他框架在不同情况下的性能数据以供参考。
...
- [Example](https://github.com/minogump/kitex-examples)：Kitex 的使用示例。
